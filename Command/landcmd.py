...
class Commander:
    def __init__(self):
        ...
        rate = rospy.Rate(20)
        self.position_target_pub = rospy.Publisher('cmd/set_pose/position1',    PoseStamped, queue_size=10)
        self.yaw_target_pub      = rospy.Publisher('cmd/set_pose/orientation', Float32,     queue_size=10)
        self.custom_activity_pub = rospy.Publisher('cmd/set_activity/type',    String,      queue_size=10)
